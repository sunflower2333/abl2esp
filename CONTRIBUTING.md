...
1. [Fork](https://github.com/qualcomm/abl2esp/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/abl2esp.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/abl2esp.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/abl2esp/pulls) from your branch to `main`.
